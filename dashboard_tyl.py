...
GDRIVE_PATH = os.path.expanduser(
    "~/Google Drive/My Drive/TYL"          # Mac / Linux
    # "C:/Users/TuUsuario/Google Drive/TYL" # Windows
)

FILES = {
    "fact": os.path.join(GDRIVE_PATH, "FACTURACION_JUNIO_23_2026__account_move_.xlsx"),
    "cart": os.path.join(GDRIVE_PATH, "CARTERA__account_move_.xlsx"),
    "vis":  os.path.join(GDRIVE_PATH, "VISITAS_JUNIO_calendar_event_.xlsx"),
    "cot":  os.path.join(GDRIVE_PATH, "Cotizaciones_crm__crm_lead_-2.xlsx"),
}
